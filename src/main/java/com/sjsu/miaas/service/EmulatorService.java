...
public class EmulatorService {
	...
	public JSONArray getAppsForDevice(String id)throws MalformedURLException, IOException, ProtocolException, JSONException{
		String devId = null;
		...
		//TODO change the targetUrl to the get apps url
		URL targetUrl = new URL("http://" +amzInst.getPublicDnsName() + ":8080/simpleapp/webapi/androidcontrol/startemulator");
//		URL targetUrl = new URL("http://ec2-54-148-4-92.us-west-2.compute.amazonaws.com:8080/simpleapp/webapi/androidcontrol/startemulator");
		...
		try {
			apps = new JSONArray(sb.toString());
		} catch (org.json.JSONException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
	...
	public String startAppForDevice(String id, String appName)throws MalformedURLException, IOException, ProtocolException, JSONException{
		String devId = null;
		Device device = devRepository.getDevicesByDeviceId(id);
