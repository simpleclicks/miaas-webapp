...
@Configuration
@EnableJpaRepositories("com.sjsu.miaas.repository")
...
public class DatabaseConfiguration implements EnvironmentAware {
    ...
    @ConditionalOnMissingClass(name = "com.sjsu.miaas.config.HerokuDatabaseConfiguration.class")
    ...
    public List<String> getBasePackages() {
        ...
        basePackages.add("com.sjsu.miaas.domain");
        return basePackages;
    }
